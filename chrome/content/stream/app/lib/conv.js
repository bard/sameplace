...
conv.toString = function(thing) {
    if(thing instanceof Element)
        return conv.serializer.serializeToString(thing);
    else
        switch(typeof(thing)) {
        case 'xml':
...
conv.toXML = function(domElement) {
    return new XML(conv.serializer.serializeToString(domElement));
};

conv.toDOM = function(thing) {
    return conv.parser.parseFromString((typeof(thing) == 'xml' ?
